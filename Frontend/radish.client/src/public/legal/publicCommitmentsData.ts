export const publicCommitmentsSourceLanguage = 'zh-CN';

export interface PublicCommitmentSection {
  id: string;
  eyebrow: string;
  title: string;
  description: string;
...
export const publicCommitmentsHero = {
  eyebrow: 'Radish Community Commitments',
  title: '正式用户承诺与社区边界',
  description: '本页面向所有用户说明 Radish 当前正式产品边界：社区内容如何互动，公开与私域信息如何区分，虚拟商品和资产如何理解，以及遇到问题时应如何提供可追踪证据。',
} as const;

export const publicCommitmentSummaries = [
  {
    label: '核心主线',
    title: '帖子、聊天、关系',
    description: 'Docs、商城、资产、宠物、经验、通知和 Workbench 都服务社区内容生产、互动和复访。',
  },
  {
    label: '信任来源',
    title: '举报、快照、审计',
    description: '治理判断应可回看目标、上下文、处理理由和动作日志。',
  },
  {
    label: '资产边界',
    title: '虚拟权益，不等同现金',
    description: '虚拟商品、胡萝卜、经验和背包权益不提供现金价值承诺。',
  },
] as const;

export const publicCommitmentSections: readonly PublicCommitmentSection[] = [
  {
    id: 'community',

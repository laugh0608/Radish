...
internal static partial class InitialDataSeeder
{
    ...
    [
        ...
        new(61032, 61030, ConsolePermissions.OrdersRemark, "备注订单", "Button", "orders", null, 42, false, false),
        new(61040, 0, ConsolePermissions.UsersView, "用户管理", "Page", "users", "/users", 50, true, true, "用户管理页面"),
        new(61041, 61040, ConsolePermissions.BenefitsView, "查看用户权益", "Button", "users", null, 51, false, false),
        new(61042, 61040, ConsolePermissions.BenefitsRevoke, "撤销用户权益", "Button", "users", null, 52, false, false),
        new(61150, 0, ConsolePermissions.ChannelDiscoverabilityView, "频道公开摘要", "Page", "channel-discoverability", "/channel-discoverability", 53, true, true, "显式管理频道是否进入匿名社区发现摘要"),
        new(61151, 61150, ConsolePermissions.ChannelDiscoverabilityManage, "修改频道公开摘要", "Button", "channel-discoverability", null, 54, false, false, "开启或关闭频道匿名公开摘要资格"),
        ...
        new(61145, 61140, ConsolePermissions.DocsPermissions, "文档权限策略", "Button", "documents", null, 835, false, false),
        new(61146, 61140, ConsolePermissions.DocsRollback, "回滚文档版本", "Button", "documents", null, 836, false, false),
        new(61147, 61140, ConsolePermissions.DocsImport, "导入 Markdown", "Button", "documents", null, 837, false, false),
        new(61148, 61140, ConsolePermissions.DocsExport, "导出 Markdown", "Button", "documents", null, 838, false, false),
        ...
        new(61133, 61130, ConsolePermissions.ExperienceFreeze, "冻结与解冻经验", "Button", "experience", null, 89, false, false),
    ...
    [
        ...
        new(61020, "/api/v1/Shop/AdminGetProduct/\\d+", "View"),
        ...
        new(61030, "/api/v1/Shop/AdminGetOrder/.+", "View"),
        new(61041, "/api/v1/Shop/AdminGetEntitlementOperations", "View"),
        new(61041, "/api/v1/Shop/AdminGetUserBenefits", "View"),
        new(61042, "/api/v1/Shop/AdminRevokeBenefit/.+", "Action"),
        new(61031, "/api/v1/Shop/RetryGrantBenefit/.+", "Action"),
        new(61032, "/api/v1/Shop/AdminRemarkOrder/.+", "Action"),
        ...
        new(61050, "/api/v1/ConsoleAuthorization/GetResourceTree", "View"),
        new(61050, "/api/v1/ConsoleAuthorization/GetRoleAuthorization", "View"),
        new(61050, "/api/v1/ConsoleAuthorization/GetRolePermissionPreview", "View"),
        new(61051, "/api/v1/Role/CreateRole", "Action"),
        new(61052, "/api/v1/Role/GetRoleById", "View"),
        new(61052, "/api/v1/Role/UpdateRole", "Action"),
        new(61052, "/api/v1/ConsoleAuthorization/SaveRoleAuthorization", "Action"),
        ...
        new(61141, "/api/v1/Wiki/Unpublish/\\d+", "Action"),
        new(61142, "/api/v1/Wiki/Archive/\\d+", "Action"),
        new(61143, "/api/v1/Wiki/Delete/\\d+", "Action"),
        new(61144, "/api/v1/Wiki/Restore/\\d+", "Action"),
        new(61145, "/api/v1/Wiki/UpdateAccessPolicy/\\d+", "Action"),
        new(61146, "/api/v1/Wiki/Rollback/\\d+", "Action"),
        new(61147, "/api/v1/Wiki/ImportMarkdown", "Action"),
        new(61148, "/api/v1/Wiki/ExportMarkdown/\\d+", "Action"),
        ...
        new(61130, "/api/v1/Experience/GetUserDailyStats/.+", "View"),
        new(61130, "/api/v1/Experience/GetLevelConfigs", "View"),
        new(61130, "/api/v1/Experience/GetUserGovernanceActions/.+", "View"),
        new(61130, "/api/v1/Experience/GetUserTransactions/.+", "View"),
        new(61131, "/api/v1/Experience/AdminAdjustExperience", "Action"),
        new(61133, "/api/v1/Experience/AdminFreezeExperience", "Action"),
        new(61133, "/api/v1/Experience/AdminUnfreezeExperience", "Action"),
        new(61133, "/api/v1/Experience/AdminRecordGovernanceReview", "Action"),

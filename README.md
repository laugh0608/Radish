...
<p align="center">
  <img src="./Docs/radish.docs/docs/images/RadishAcg-256.png" alt="萝卜娘" width="256">
</p>
...
```
Radish/
├── Docs/radish.docs/                 # 📚 VitePress 文档站（开发规范、架构设计、部署指南等）
...
完整的开发文档现位于 `Docs/radish.docs/docs/` 目录（同时也是在线文档站的源文件）：

### 核心文档
- 📘 [**开发规范**](Docs/radish.docs/docs/architecture/specifications.md) - 目录职责、分层依赖、代码约定
- 📗 [**架构设计**](Docs/radish.docs/docs/architecture/framework.md) - 技术选型、分层架构、数据持久化
- 📙 [**开发计划**](Docs/radish.docs/docs/development-plan.md) - 里程碑与迭代计划
- 📕 [**开发日志**](Docs/radish.docs/docs/changelog/) - 按月份/周记录的开发历程

### 专项文档
- 🔐 [**认证与权限**](Docs/radish.docs/docs/guide/authentication.md) - OIDC 认证流程与权限体系
- 🎨 [**前端设计**](Docs/radish.docs/docs/frontend/design.md) - WebOS 桌面范式与应用集成方式
- 🚪 [**Gateway 服务网关**](Docs/radish.docs/docs/guide/gateway.md) - 统一服务入口与路由转发
- 🚀 [**部署指南**](Docs/radish.docs/docs/deployment/guide.md) - 容器化、CI/CD、生产部署
- 🧩 [**文件上传设计**](Docs/radish.docs/docs/features/file-upload-design.md) - 文件上传与图片处理方案
- 🦀 [**Rust 扩展**](Docs/radish.docs/docs/guide/rust-extensions.md) - radish-lib 使用指南

### 前端文档
- 🎨 [**UI 组件库**](Docs/radish.docs/docs/frontend/ui-library.md) - @radish/ui 入口文档
- 🧱 [**组件说明**](Docs/radish.docs/docs/frontend/components.md) - 组件与用法说明
- ⚡ [**快速参考**](Docs/radish.docs/docs/frontend/quick-reference.md) - 常用 API 速查表

### 其他资源
- 📖 [**文档首页**](Docs/radish.docs/docs/index.md) - 文档地图与推荐阅读路径
...
更多配置细节参见 [开发规范](Docs/radish.docs/docs/architecture/specifications.md)。
...
完整规范详见 [architecture/specifications.md](Docs/radish.docs/docs/architecture/specifications.md)。
...
| radish.docs | `Docs/radish.docs/package.json` | `version` |
...
详细规范参见 [版本号规范](Docs/radish.docs/docs/architecture/specifications.md#项目版本号规范)。
...
请确保：
1. 代码遵循项目 [开发规范](Docs/radish.docs/docs/architecture/specifications.md)
2. 单元测试通过（`dotnet test`）
3. 提交前运行 `npm run lint --prefix Frontend/radish.client`
4. 在 [开发日志](Docs/radish.docs/docs/changelog/) 中记录重大变更

...
| M6 | 积分与商城 | 积分规则、事件订阅、商城商品与库存、购买链路 | 发帖/互动触发积分，商城购买扣减积分并更新权益 | 🚧 进行中 (2025.12.28~) |
...
> **当前进度**：✅ M5（文件上传与内容增强）已于 2025.12.28 完成，🚧 M6（积分与商城）于 2025.12.28 开始。
>
...
>
> **M6 进度说明**：本阶段重点是积分系统设计与实现（PointLedger 账本、PointTransaction 流水、事件触发）、商城商品与库存管理、购买链路。详细方案待确定。

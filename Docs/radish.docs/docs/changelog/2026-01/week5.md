...
#### 统一认证服务 (5710490)
- **新增文件**: `Frontend/radish.client/src/services/auth.ts`
- **提供方法**:
...
- **更新文件**:
  ...
  - `AGENTS.md` - 同步更新
  - `Docs/radish.docs/docs/architecture/specifications.md` - 添加聚合查询和工具方法说明
- **内容**: 补充 BaseService 新增方法的使用规范

#### 无关紧要的更改 (37fa340)
- 删除 `Frontend/radish.client/CHANGELOG.md`
- 删除 `Frontend/radish.console/CHANGELOG.md`
- 更新 `Radish.slnx`

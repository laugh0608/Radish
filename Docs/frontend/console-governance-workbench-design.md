...
> 状态：`P3-12-D5` 已完成 Console 治理设计源 `P00-P18` 设计收口；`P3-12-D14-D27` 已完成 `radish.console` 壳层首批、系统设置、订单、用户、商品、文档治理首屏、标签 / 分类、贴纸类页面、角色权限页面、内容 / 经验治理工作台外层语义迁移、点名内部区块样式收口、治理页面成组静态收口、复杂页面类型边界评估和系统工具 / 运维外壳收口
>
...
`P3-12-D14-D27` 已完成第二轮 Console 语义迁移、成组静态收口与复杂页面类型边界评估：
...
- `P3-12-D28` 优先整理 D14-D27 更大范围静态阶段收口与剩余风险。
...
6. 下一批优先整理 D14-D27 更大范围静态阶段收口；若进入内部运维平台，先补 API / 数据模型设计。
6. 移动端实现不把 PC 表格硬缩，按 `P14-P18` 的任务卡、分组详情和底部动作重排。

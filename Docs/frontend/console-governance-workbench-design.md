...
> 状态：`P3-12-D5` 已完成 Console 治理设计源 `P00-P18` 设计收口；`P3-12-D14-D23` 已完成 `radish.console` 壳层首批、系统设置、订单、用户、商品、文档治理首屏、标签 / 分类、贴纸类页面和角色权限页面的语义组件迁移、成组静态收口与复杂页面类型边界评估
>
...
`P3-12-D14-D23` 已完成第二轮 Console 语义迁移、成组静态收口与复杂页面类型边界评估：
...
- `P3-12-D24` 优先按 `P02 / P03` 推进内容治理和经验治理工作台外层语义收口，不把举报审核、手动治理、经验复核、冻结 / 解冻和管理员调整压进普通表格工具条。
...
2. D24 优先推进 `P02 / P03` 内容治理与经验治理工作台外层语义收口。
3. 内容治理和经验治理迁移前继续确认首屏区块、证据 / 动作 / 留痕结构和移动任务流，不把普通表格迁移口径直接套用到治理工作台。

...
- `private-web-workflows.pen`：私域与作者态 Web 工作流设计端点，当前包含 `P01-P30` 编号画板、通知状态补充画板 `P12B / P26B / P26C` 及消息状态补充画板 `P13B / P27B`，覆盖 `/workbench`、`/me` 系列、资产流水、订单、背包、通知、消息、圈子、宠物、论坛作者态、Docs 作者态和移动端单任务页面。

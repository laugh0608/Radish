...
- 公开内容壳层当前已从 forum 开始首批落地：`/forum` 与 `/forum/post/:postId` 已可直接进入公开阅读壳层；当前下一批已开始补 `/docs` 与 `/docs/:slug`
...
- 公开内容壳层当前已从 forum 开始首批落地，帖子列表与帖子详情可以绕开桌面 Shell 直接进入公开阅读形态；文档阅读当前也已开始补公开目录与正文阅读入口
- 公开 forum 当前只冻结“列表 + 详情 + 轻回应墙展示 + 评论阅读”，并明确保持只读阅读边界
- 公开文档阅读当前只冻结“目录 + 正文阅读 + 文档内链跳转”，并明确保持只读阅读边界
...
- 个人公开页与更深的轻互动能力，仍按价值逐步接入，不一次性照搬桌面 App

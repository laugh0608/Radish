...
- forum 公开分类、公开标签、公开结构化类型与公开搜索首批当前只承载分类 / 标签 / 类型上下文、关键词检索、帖子列表阅读、排序分页与详情回跳上下文；[F4-Q-A](/features/forum-tag-public-discovery-seo-design)已固定标签相关主题、公开可见性、Gateway 首包 head 与 tags sitemap 的后续实施边界

...
- 公开内容壳层当前已从 forum 开始首批落地：`/forum` 与 `/forum/post/:postId` 已可直接进入公开阅读壳层
- 公开内容壳层当前仍保持首批只读阅读边界，不承载发帖、评论提交、投票提交或桌面工作台交互
...
- 公开内容壳层当前已从 forum 开始首批落地，帖子列表与帖子详情可以绕开桌面 Shell 直接进入公开阅读形态
...
- 文档阅读、个人公开页与更深的轻互动能力，仍按价值逐步接入，不一次性照搬桌面 App

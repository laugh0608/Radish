...
- 公开内容壳层当前已完成 forum 与 docs 两个首批入口：`/forum`、`/forum/post/:postId`、`/docs` 与 `/docs/:slug` 都已可直接进入公开阅读壳层；下一批转向个人公开页首批
...
- 公开内容壳层当前已完成 forum 与 docs 两个首批入口落地，帖子列表、帖子详情、公开文档目录与正文阅读都可以绕开桌面 Shell 直接进入公开阅读形态

...
>
> 状态：设计源 `P01-P16` 已补齐；公开 Web 当前发布前范围 `P01-P14` 已完成首轮前端实现、Gateway PC / mobile CSS 视口真实 smoke、E7-B / E7-C 用户语言和信息密度收口，以及 E8 首日正式 Web 主导航和公开文档口径回拉；`P15 / P16` 作为后续公开聊天室参考，不阻断当前 UI 专题退出判断
...
- 公开文档的列表、目录、搜索结果和详情内容只承载公开已发布文档；作者草稿、登录可看文档、受限文档和回收站状态进入 Docs 作者态或 Console 治理，不在公开阅读页混排。

...
>
> 更新：2026-07-07（Asia/Shanghai）：`P3-12-E7-D` 已在 `web-ui-foundation.pen` 新增并三次收紧 `E7-D - Auth Consent Information Hierarchy` 画板，固定 Auth 授权确认页具体决策卡的请求应用、账号状态、返回位置、权限用途、敏感边界、技术信息下沉和移动端确认动作层级。
>
...
| `E7-D - Auth Consent Information Hierarchy` | Auth 授权确认页具体决策卡参考，覆盖请求应用、当前账号、返回位置、权限用途、敏感边界、技术信息下沉和移动端确认动作 |

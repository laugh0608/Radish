...
>
> 当前已完成首批公开增长基线：运行时 head / canonical、公开详情分享入口、公开个人页复制链接入口、运行时 JSON-LD、API + Gateway 动态 sitemap，以及 forum / docs / shop 公开详情首包 head snapshot 注入。完整正文 SSR / SSG、预渲染和公开个人页动态 sitemap 继续后置。

...
- 当前已进入发布后常态开发与 F4；一对一私聊、F4-B 至 F4-Q、F4-S 及 F4-R Web 页面族 / 主题退出门禁均已关闭，`v26.8.1-release` 正式 tag 与五镜像发布完成。Flutter Native P1 / P2 / P3、P4-A、P4-B1–B5、P5-A、P5-B1、P5-B2、P5-C1、P5-C2、P5-C3、P5-D1、P5-D2 与 P5-D3 已完成；下一顺位只做 P5-E grouped static gate readiness，生产部署与长期运维由项目所有者独立负责，不进入当前开发顺位。

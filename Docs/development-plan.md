...
- `Phase 2-3` 第五批暂不直接开工，候选方向优先限定为 `profile` 最近阅读轻量多条列表、docs 搜索体验小增强、forum detail 轻回应发布后局部体验补强

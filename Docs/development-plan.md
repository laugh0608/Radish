...
- **当前阶段**：`截至 2026-03-16，M12 已完成抽奖与浏览记录后端首轮骨架提交（2792b29）；当前进入抽奖前端收口、个人中心浏览记录前端展示与验收脚本补齐阶段。`
- **并行治理尾项**：
  - 身份语义 Phase 4：协议输出收敛
...
9. **P5 论坛抽奖 MVP 已确认启动**
   ...
   - 当前按 [论坛抽奖 MVP 设计方案](/features/forum-lottery-mvp) 继续推进前端发帖入口、列表摘要与详情卡片

10. **个人中心浏览记录优化已纳入本轮并行小项**
   - 个人中心将新增“浏览记录”标签页
   - 第一版先覆盖帖子详情、商品详情与文档页
   - 后端采集与个人中心读取接口已接通，当前待补前端展示与深链跳转

...
- **产品下一顺位**：`在继续 Native 产品能力与 P8 desktop platform readiness 之间裁决；P7-D2 / D3 暂缓`
...
- 当前已进入发布后常态开发与 F4；一对一私聊、F4-B 至 F4-Q、F4-S 及 F4-R Web 页面族 / 主题退出门禁均已关闭，`v26.8.1-release` 正式 tag 与五镜像发布完成。Flutter Native P1–P5、P6 Android 双 AVD、P7-C iOS Simulator 与 P7-D1 minimal readiness 均已关闭；P6-C 真机验收转为 Android 分发前门禁。项目所有者当前没有 Apple Developer Program 付费会员或可测试真机，因此 P7-D2 / D3 暂缓，当前先做不依赖 Apple 外部条件的 post-P7 候选审计；External TestFlight / App Store 与账号删除、完整 Flutter UGC、StoreKit / IAP 无限期后置。生产部署与长期运维由项目所有者独立负责，不进入当前开发顺位。

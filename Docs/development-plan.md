...
- `35%`：`P3-10-D Web 信息流 / UI 结构整理` 前置设计与信息结构确认，优先覆盖 `/discover`、公开论坛详情、公开个人页、`/circle`、`/me` 和轻互动入口。
...
- `P3-10-D Web 信息流 / UI 结构整理`
  - 当前开发主线优先确认 `/discover`、公开论坛详情、公开个人页、`/circle`、`/me` 和轻互动入口的信息结构、视觉层级、真实内容密度和返回语义。

...
>
> **当前主线焦点**（2026-03-09 复核，按仓库实际进度更新）：
...
> - ✅ **M12-P1「内容与文档体系重构」中的文档应用 A 阶段验收已完成**：固定文档展示、在线文档闭环、Markdown 导入导出、版本回滚、入口口径与迁移试点保护均已通过业务侧人工验收，当前进入“迁移试点 + 下一阶段评估”节奏；身份专项尾项作为并行工程治理任务继续收尾。
>
...
>   - 详见 [统一文档系统设计与实施方案](/guide/document-system)。
>   - ✅ 已完成 `radish.docs` 独立项目下线；固定文档统一收口到仓库 `Docs/`，并由“文档”应用承接展示。
...
>   - **当前执行顺序**：
>     1. ✅ 已完成 Markdown 导入/导出接口与最小前端交互；
>     2. ✅ 已完成固定文档同步与“文档”应用展示承接；
>     3. 继续收口旧口径、导航与历史文档映射策略。
>
...
- 文档体系：落地 Markdown 导入/导出，并完成 `radish.docs` 下线与统一“文档”应用承接。
...
- 验收：
  ...
  - 文档应用 A 阶段已完成业务侧验收，当前进入迁移试点与下一阶段评估。

...
4. **体验主线纳入首版，但要收敛范围**
   ...
   - 当前 `radish.client` i18n 已完成桌面壳层、商城主链路、论坛高频讨论链路，以及聊天、通知中心、个人中心高频模块的首轮覆盖，下一步继续补文档应用与剩余业务页。
...
13. **`radish.client` i18n 首轮高频覆盖已推进**
   ...
   - 当前结论为：`radish.client` i18n 不再处于“待启动”状态，但文档应用与剩余论坛 / 通知 / 个人中心边缘页仍待继续补齐
...
- `radish.client` 国风视觉基线已完成规范冻结与桌面壳层首批落地，`i18n` 也已完成桌面壳层、商城主链路、论坛高频讨论链路，以及聊天 / 通知中心 / 个人中心高频模块的首轮覆盖；后续继续推进文档应用与剩余业务页适配、主题 token 收口
- `M13` 首轮验证入口回归观察与补漏

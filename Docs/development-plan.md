...
- 当前已进入发布后常态开发与 F4；一对一私聊、F4-B 至 F4-Q、F4-S 及 F4-R Web 页面族 / 主题退出门禁均已关闭，`v26.8.1-release` 正式 tag 与五镜像发布完成。Flutter Native P1–P5、P6 Android 双 AVD、P7-C iOS Simulator、P7-D1 minimal readiness、P8-A / B readiness 与 P8-B1 macOS platform foundation 均已关闭；P6-C 真机验收转为 Android 分发前门禁，P7-D2 / D3 因会员与真机前置暂缓。当前等待 P8-B2 本地 Gateway 运行启动授权，Windows / Linux 分别后置 P8-C / D。External TestFlight / App Store 与账号删除、完整 Flutter UGC、StoreKit / IAP 无限期后置。生产部署与长期运维由项目所有者独立负责，不进入当前开发顺位。

...
- Web 工作台详情页订阅全部评论事件和 typing；公开详情页订阅评论 / 点赞 / 高亮变化事件并支持登录后根评论发布，但不展示 typing 输入提示，也不开放评论回复、点赞或删除的公开互动。论坛作者态的帖子编辑由正式 Web 详情受控 `intent=edit` 承接，不属于评论高亮专题。匿名公开页仍保持阅读边界。

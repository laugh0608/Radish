...
- 2026-07-18 已完成一对一私聊专题设计：继续复用 `Channel / ChannelMember / ChannelMessage`，新增的 `DirectConversation` 只承担参与者、请求和阻断状态；私聊成员 ACL、消息幂等和 Chat 附件访问是开放入口前置。
...
- 消息搜索、Reaction、置顶和逐条阅读回执继续作为独立后续能力，不与私聊专题绑定交付。

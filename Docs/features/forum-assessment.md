...
**文件**: `Frontend/radish.client/src/apps/forum/ForumApp.tsx` (513 行)
...
- [ ] 用户个人主页
- [ ] 通知系统（新回复提醒）
- [x] 帖子收藏历史（F4-P 已完成私有权威关系与 `/me/content?tab=bookmarks`）
- [ ] 帖子点赞历史
- [ ] 版主权限管理
- [ ] 响应式设计优化
...
| 获取根评论分页 | `GET /api/v1/Comment/GetRootComments?postId={id}&pageIndex=1&pageSize=20&sortBy=default` | ✅ |

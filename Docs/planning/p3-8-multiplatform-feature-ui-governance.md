...
- 下一步不继续重复 Flutter 个人主页来源返回、公开主页链接展示、轻量通知列表、公开商城列表、论坛详情评论发布 / 回复、评论登录回流、原生公开详情分享入口、公开文档阅读链路、订单 / 背包只读入口、订单详情 / 背包来源承接或登录态通知只读列表验收，也不继续逐页打磨 Web 公开页；纯 Web 已补 forum 参与和 shop 购买意图回流，后续继续从 Flutter 真实移动主路径或跨端回流高信号缺口中选择。

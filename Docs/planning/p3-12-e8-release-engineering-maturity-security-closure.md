...
- Q1-A、Q1-B、Q1-C 与 Q2-A 高风险时间语义已完成；当前进入 Q2-B PostgreSQL / OpenIddict 数据库演进方案。完整领域错误码和全仓时间存量继续按触达范围迁移，不回流为当前主线。
...
- 候选运行态与回滚材料决定工程 Release Go；真实使用观察从发布后开始并进入维护 / 功能 backlog。

...
- 下一顺位建议进入 `P3-12-D61 Public Web Pencil 逐页 UI 与功能缺口实现`：按 `public-web-unified-experience.pen` 的 `P01-P14` 页面族补 UI 设计差距和现有 API 内可承接的前端功能状态；`P15-P16` 公开聊天室作为 Public 小专题内的后置产品 / API 缺口记录，不再放入全局功能缺口总专题。

...
- **当前阶段**：`2026-03-16 已完成后端首轮骨架提交（2792b29），当前进入前端收口与验收资产补齐阶段：优先完成论坛抽奖前端，再接个人中心浏览记录前端。`
- **复核日期**：`2026-03-16`
...
- [x] 抽奖开奖接口与最小回归测试
- [ ] 欢迎 App 中论坛发帖弹窗与帖子详情抽奖交互
- [ ] 个人中心浏览记录采集与展示
- [ ] `HttpTest` 与人工验收脚本补齐

### 下一步拆分

- 第 1 步：完成论坛发帖弹窗的“附带抽奖”配置区与请求字段接入
- 第 2 步：完成帖子列表 / 详情的抽奖摘要、开奖按钮与中奖名单展示
- 第 3 步：完成个人中心浏览记录前端列表与帖子 / 商品 / Wiki 跳转联动
- 第 4 步：补 `HttpTest`、最小人工验收脚本与一次联调记录

### 当前结论

- 当前主线已明确，不再保持“待确认”空档状态
- 抽奖作为本轮 M12 新增主功能，继续沿用论坛主链扩展策略
- 浏览记录作为并行小优化推进，范围保持克制，不扩张成完整足迹系统
- 后端首轮骨架已完成独立提交，当前工作区仅保留抽奖前端半成品，方便下一轮继续分步提交
...
> 当前主线已切换到 `P5 论坛抽奖 MVP + 个人中心浏览记录优化`，以下只保留后续候选池。
...
- 已确认当前最小闭环：
  ...
  - 发帖者手动开奖
  - 列表轻摘要与详情中奖名单
- 当前状态：已进入当前主线，后续按 `forum-lottery-mvp` 文档推进实现与验收

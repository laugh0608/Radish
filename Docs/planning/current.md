...
1. 按 [F3 i18n 完成度治理实施说明](/frontend/i18n-completion-governance)继续 `F3-C`：推进 client Docs 作者态、圈子、宠物、经验、萝卜坑与低频设置，以及 Console 商品、文档、权限、分类标签、表情、经验和胡萝卜管理；不重新混入已收口的主题运行时或后置在线翻译平台。

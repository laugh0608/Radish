...
- **最近结论**：
  ...
  - 当前主线已从“多端路线收口后的产品功能开发推进”“第二阶段收口评审”、`P2-C5-A` Flutter 首批补强和下一阶段主任务选择，切到 `P3-0`
  ...
  - 当前先做阶段目标、边界、首批任务候选、主路径审计和代码热区审计，不直接铺第三阶段大功能
...
1. **`P3-0` 第三阶段定义与工程整备**
   - 定义第三阶段目标、边界、首批任务候选与验证口径
   - 做公开内容壳层、WebOS 工作台、Flutter、Console / 后端治理、外部 ID 契约和代码热区的窄范围审计
   - 当前不直接铺大功能，先给出可执行的第一批开工任务
2. **第二阶段收口护栏**
...
- 先完成 `P3-0`：第三阶段定义、主路径审计、代码热区审计和第一批任务排序
- 默认第一批候选顺序为公开内容增长基础、`PublicId` 最小试点方案、代码热区拆分、用户留存轻闭环
...
- `P3-0 第三阶段定义与工程整备`：完成主路径与代码热区审计，给出第一批正式开工任务的范围、完成条件和验证入口

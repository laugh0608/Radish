...
1. **启动 P3-12 Web 完全化与 WebOS 收束**
   ...
   - `P3-12-B3` 论坛作者态 Web 化首批代码和小阶段验收已完成：`/forum/compose`、详情 `intent=answer|edit|history`、正式 Web 登录回流、发帖 / 回答 / 编辑 / 历史查看和 `clientSubmissionId` 延续均已收口；下一步进入 `P3-12-B4` 文档作者态归属裁决。
...
- `P3-12 Web 完全化与 WebOS 收束`
  ...
  - `P3-12-B2` 首批代码已补 `/me/content`、`/me/history`、`/me/attachments`、`/me/experience` 的路由、登录回流和正式 Web 导航语义，方案见 [P3-12-B2 完整个人中心 Web 化方案](/records/p3-12-b2-personal-center-web-plan-2026-06-21)；`P3-12-B3` 首批代码与小阶段验收已完成，见 [P3-12-B3 论坛作者态 Web 化方案](/records/p3-12-b3-forum-author-web-plan-2026-06-21)。下一步进入 `P3-12-B4` 文档作者态归属裁决。
...
- 先读取本页、[P3-12 Web 完全化与 WebOS 收束](/planning/p3-12-web-completion-webos-retirement)、[P3-12-B3 论坛作者态 Web 化方案](/records/p3-12-b3-forum-author-web-plan-2026-06-21) 和 [2026-06-21 收工回顾与明日事项](/records/daily-handoff-2026-06-21)，确认 B1 / C1 / B2 已完成首批代码，B3 已完成首批代码与小阶段验收，当前不是 C1 扩面清扫或 UI 美化线。
- 第一顺位：进入 `P3-12-B4` 文档作者态归属裁决，先盘点现有 WebOS Wiki / Docs、公开文档页、文档写入 API / 路由和 Console 可能归属，再决定正式 Web 管理页、Console 治理页或 WebOS 历史维护线。

...
1. 按 [F3 i18n 完成度治理实施说明](/frontend/i18n-completion-governance)继续 `F3-C`：推进 client 经验、萝卜坑、低频设置与公开承诺，以及 Console 权限、分类标签、表情、经验和胡萝卜管理；不重新混入已收口的主题运行时、Docs / 商品 / 圈子 / 宠物域或后置在线翻译平台。

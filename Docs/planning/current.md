...
- **最近结论**：
  ...
  - `P3-12-B4` 文档作者态归属裁决已完成只读盘点和方案记录：公开 `/docs` 保持阅读 / 搜索 / 分享，正式 Web 优先承接登录态文档作者页，Console 承接发布、撤回、归档、恢复、权限配置、导入导出和回滚等治理动作，WebOS `WikiApp` 只作为 `/desktop` 历史维护入口保留；下一步确认 B4-1 正式 Web 作者入口代码范围，记录见 [P3-12-B4 文档作者态归属裁决](/records/p3-12-b4-doc-author-ownership-plan-2026-06-22)。
...
1. **启动 P3-12 Web 完全化与 WebOS 收束**
   ...
   - `P3-12-B4` 文档作者态归属裁决已形成方案：公开 `/docs` 保持阅读态，正式 Web 优先承接登录态作者页，Console 承接治理动作，WebOS Wiki 退为历史维护入口；下一步确认 B4-1 正式 Web 作者入口代码范围。
...
- `P3-12 Web 完全化与 WebOS 收束`
  ...
  - `P3-12-B2` 首批代码已补 `/me/content`、`/me/history`、`/me/attachments`、`/me/experience` 的路由、登录回流和正式 Web 导航语义，方案见 [P3-12-B2 完整个人中心 Web 化方案](/records/p3-12-b2-personal-center-web-plan-2026-06-21)；`P3-12-B3` 首批代码与小阶段验收已完成，见 [P3-12-B3 论坛作者态 Web 化方案](/records/p3-12-b3-forum-author-web-plan-2026-06-21)；`P3-12-B4` 文档作者态归属裁决已完成，见 [P3-12-B4 文档作者态归属裁决](/records/p3-12-b4-doc-author-ownership-plan-2026-06-22)。下一步确认 B4-1 正式 Web 作者入口代码范围。
...
- 先读取本页、[P3-12 Web 完全化与 WebOS 收束](/planning/p3-12-web-completion-webos-retirement)、[P3-12-B3 论坛作者态 Web 化方案](/records/p3-12-b3-forum-author-web-plan-2026-06-21)、[P3-12-B4 文档作者态归属裁决](/records/p3-12-b4-doc-author-ownership-plan-2026-06-22) 和 [2026-06-21 收工回顾与明日事项](/records/daily-handoff-2026-06-21)，确认 B1 / C1 / B2 已完成首批代码，B3 已完成首批代码与小阶段验收，B4 已完成归属裁决，当前不是 C1 扩面清扫或 UI 美化线。
- 第一顺位：确认并推进 `P3-12-B4-1` 正式 Web 文档作者入口，优先覆盖 `/docs/mine`、`/docs/compose`、`/docs/edit/:id`、`/docs/revisions/:id` 的登录回流、路由契约、创建 / 编辑和版本回看；Console 文档治理作为 B4-2 单独批次。
- 第二顺位：若 B4 盘点暴露页面归属、接口契约、权限边界或运行时行为分歧，先写清方案并等待确认；只读盘点、文档边界和低风险说明同步可直接整理。

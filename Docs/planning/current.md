...
- `P3-8-D 多端主路径缺口补齐与验收矩阵`
  ...
  - 第二顺位：评估 Flutter 下一批高价值功能；公开个人页到帖子 / 评论详情的 Android Back 来源返回已补 smoke，不再作为下一步重复推进，不复刻 WebOS
  - 第三顺位：若 Flutter 评估未选出更高价值任务，再回看纯 Web 登录后轻量链路或跨端回流缺口，不直接启动完整移动商城、完整通知中心或完整创作器

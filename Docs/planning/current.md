...
- **最近结论**：
  ...
  - `P2-C4 商城权益效果收口` 已完成未开放权益 / 道具入口下收、商品种子与存量上架态对齐、订单 `StockType` 快照、超时取消回补与商城消费扣款链路收口，下一步转向购买后资产闭环与通知稳定性
...
- `P2-C4 商城购买后闭环`：优先补齐背包 `UserInventoryVo` 契约与前端渲染、商城购买支付密码输入与服务端校验、购买成功通知进入通知中心后的循环更新 / 白屏问题，再做一轮人工验收

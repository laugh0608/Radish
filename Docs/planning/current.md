...
- 先读取本页、[P3-12 Web 完全化与 WebOS 收束](/planning/p3-12-web-completion-webos-retirement)、[P3-12-D2 公开 Web 统一体验设计源记录](/records/p3-12-d2-public-web-unified-design-source-2026-06-24)、[P3-12-D3 私域与作者态 Web 工作流设计源记录](/records/p3-12-d3-private-web-workflows-design-source-2026-06-25)、[P3-12-D4 Web UI 共享基座设计源记录](/records/p3-12-d4-web-ui-foundation-design-source-2026-06-25)、[P3-12-D7 移动导航设计源统一记录](/records/p3-12-d7-mobile-navigation-design-source-alignment-2026-06-28)、[Web UI 共享基座设计说明](/frontend/web-ui-foundation-design)、[公开 Web 统一体验设计说明](/frontend/public-web-unified-experience-design)、[私域与作者态 Web 工作流设计说明](/frontend/private-web-workflows-design) 和 [设计源文件目录](/frontend/design-sources/README)，确认 client 视觉实现范围。
- 第一顺位：进入 `radish.client` 视觉实现前只读盘点，确认公共壳层、主题 token、公开 / 私域页面结构、状态槽和移动单列节奏的现有代码落点；不要先改 Console。
- 第二顺位：按 public / private 设计源和 `F02` 公共壳层契约推进 `radish.client` 首批视觉实现，优先沉淀共享壳层、token、公开 / 私域页面结构、资产 / 订单数据面、作者态通用结构和移动单列节奏。
- 第三顺位：完成代码后执行 `radish.client` 类型检查 / 构建和仓库卫生检查；真实 Gateway PC / mobile smoke 只在阶段验收或用户明确要求时，在用户确认前后端已启动后执行。

...
- **最近结论**：
  ...
  - `P3-12-D6` Console 视觉代码实现前盘点已完成，记录见 [P3-12-D6 Console 视觉代码实现前盘点](/records/p3-12-d6-console-visual-code-prep-2026-06-27)；但按最新设计源完整性审计，当前第一顺位改为补齐 `radish.client` 的 public / private 业务设计源，Console 代码实现后移。
...
- 第一顺位：在 `public-web-unified-experience.pen` 按 `F02` 公共壳层契约补公开论坛、文档、榜单、商城、公开主页和移动公开任务流。
- 第二顺位：在 `private-web-workflows.pen` 补 `/me` 子页、消息、通知、宠物、圈子、商城私域、文档作者态和移动私域任务流。

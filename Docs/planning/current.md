...
- `Phase 2-3` 第三批后续判断
  ...
  - 第五批首个候选方向 `profile` 最近阅读轻量多条列表已完成收口；后续候选仍可在 docs 搜索体验小增强、forum detail 轻回应发布后局部体验补强中继续择一，不默认扩完整社区互动能力

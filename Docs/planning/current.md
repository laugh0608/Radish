...
- `P3-12 Web 完全化与 WebOS 收束`
  ...
  - `P3-12-D` 继续进行；D60 已确认 D59 的无阻断 smoke 不能替代 Pencil 逐页实现和功能缺口补齐。下一步进入 `P3-12-D61 Public Web Pencil 逐页 UI 与功能缺口实现`；不进入 `P3-12-E`。
...
- 下一顺位建议进入 `P3-12-D61 Public Web Pencil 逐页 UI 与功能缺口实现`：按 `public-web-unified-experience.pen` 的 `P01-P14` 页面族补 UI 设计差距和现有 API 内可承接的前端功能状态；`P15-P16` 公开聊天室继续后置到产品 / API 专题。

...
- 先读取本页、[P3-12 Web 完全化与 WebOS 收束](/planning/p3-12-web-completion-webos-retirement)、[P3-12-D14 radish.console 视觉代码实现首批记录](/records/p3-12-d14-radish-console-visual-first-implementation-2026-06-29)、[P3-12-D6 Console 视觉代码实现前盘点](/records/p3-12-d6-console-visual-code-prep-2026-06-27) 和 [Console 治理工作台设计端点](/frontend/console-governance-workbench-design)，确认 Console 首批实现后的下一批页面迁移范围。
- 第一顺位：继续 `radish.console` 视觉代码实现，把 `ConsolePageHeader`、`ConsoleToolbar`、指标组件和侧栏分组口径迁移到订单 / 用户等高频表格代表页；治理页迁移前先确认组件边界不会压扁复杂筛选、批量操作和权限反馈。

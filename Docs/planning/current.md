...
- `P3-8-C2 Console 设计稿到实现的对齐试点`
  - 设置型页面试点已落到 `Settings`，表格 CRUD 试点已落到 `UserList / TagList / CategoryList`，调度总览试点已落到 `Dashboard`
  - 后续可继续按 `P05` 小步迁移 `SystemConfigList` 等同类历史列表页，或回看 `P02 / P03` 治理工作台实际使用后的布局细节

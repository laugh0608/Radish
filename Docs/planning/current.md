...
- **最近结论**：
  ...
  - `P3-10-D` 首日整理已完成：`/discover`、公开帖子详情、`/circle`、`/me`、公开详情轻互动入口、公开文档详情和公开个人页已完成信息结构 / 标题层级 / 公开私域边界首批整理；公开壳层阶段词、入口动作与详情规范化来源返回已完成代码侧修正。真实页面 smoke 本轮未执行，按当前节奏保留到阶段收口、准备合并或用户确认前后端已启动后集中覆盖。
...
1. **推进 P3-10-D Web 信息流 / UI 结构整理**
   - 首日公开页结构整理已完成，下一步进入 P3-10-D 阶段级收口复核。
   - 重点复核公开壳层的进入动作、分享 URL、来源返回、登录回流、公开 / 私域边界、标题层级和真实内容密度，覆盖 `/discover`、公开论坛列表 / 搜索 / 标签 / 类型流、公开帖子详情、公开文档详情、公开个人页、`/leaderboard`、`/shop`、`/circle` 和 `/me`。
...
- `P3-10-D Web 信息流 / UI 结构整理`
  ...
  - 下一步优先做阶段级收口复核：进入动作、分享 URL、登录回流、来源返回、公开 / 私域边界、标题层级、内容密度和入口动作一致性。
...
- 第一顺位：推进 `P3-10-D` 阶段级收口复核，围绕公开壳层进入动作、分享 URL、来源返回、登录回流、公开 / 私域边界、标题层级、真实内容密度和入口动作一致性，静态复核 `/discover`、公开论坛列表 / 搜索 / 标签 / 类型流、公开帖子详情、公开文档详情、公开个人页、`/leaderboard`、`/shop`、`/circle` 和 `/me`。

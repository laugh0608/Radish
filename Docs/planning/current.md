...
- 先读取本页、[P3-12 Web 完全化与 WebOS 收束](/planning/p3-12-web-completion-webos-retirement)、[P3-12-D17 radish.console 商品表格代表页视觉迁移记录](/records/p3-12-d17-radish-console-product-table-visual-migration-2026-06-29)、[P3-12-D16 radish.console 用户表格代表页视觉迁移记录](/records/p3-12-d16-radish-console-user-table-visual-migration-2026-06-29) 和 [Console 治理工作台设计端点](/frontend/console-governance-workbench-design)，确认商品页迁移后的下一批页面范围。
- 第一顺位：评估 `DocumentGovernancePage` 是否先拆分治理工作台区块，再迁入 `ConsolePageHeader`、`ConsoleToolbar`、指标组件和侧栏分组口径；如继续普通表格 CRUD 收尾，优先看标签、分类、贴纸等低风险列表页。

...
3. **第四批收口与第五批候选**
   ...
   - 第五批暂不直接开工；若继续扩 Flutter，应优先围绕已接通的 `forum / docs / profile / discover` 高价值路径补复访、轻互动与真实联调，而不是复制 WebOS 工作台能力

...
- **最近结论**：
  ...
  - `P3-10-C` 已启动首批代码推进：公开发现、公开论坛列表 / 搜索 / 标签 / 类型流和公开个人页内容项开始补齐真实链接契约，普通点击继续保留公开壳层来源返回，新开标签 / 复制链接使用公开 URL。
...
1. **收口 P3-10-B / C Web-first 首批代码**
   ...
   - `P3-10-C` 首批代码从公开内容卡片链接契约推进，优先保证真实浏览、分享、新开标签和来源返回在纯 Web 入口下保持一致。
...
- 第二顺位：围绕 `/discover`、`/forum` 详情、`/u/usr_...`、`/circle` 和 Console 高频入口推进同一组高价值入口代码，保证纯 Web 默认入口、公开详情阅读、个人页 / 圈子复访和 Console 高频治理体验一致。

...
- 先读取本页、[P3-12 Web 完全化与 WebOS 收束](/planning/p3-12-web-completion-webos-retirement)、[P3-12-D18 radish.console 文档治理页区块边界与首批语义迁移记录](/records/p3-12-d18-radish-console-document-governance-visual-boundary-2026-06-29)、[P3-12-D17 radish.console 商品表格代表页视觉迁移记录](/records/p3-12-d17-radish-console-product-table-visual-migration-2026-06-29) 和 [Console 治理工作台设计端点](/frontend/console-governance-workbench-design)，确认文档治理首屏迁移后的下一批页面范围。
- 第一顺位：继续评估文档治理详情证据、访问策略和版本治理是否需要从 Modal 拆为稳定工作台区块；如本阶段改做 Console 表格视觉收口，优先迁移标签、分类、贴纸等低风险普通列表页。

...
- **当前阶段**：`截至 2026-03-15，权限治理、聊天室 P1、论坛投票 MVP 与论坛问答 MVP 已完成本轮收口`
- **复核日期**：`2026-03-15`
...
说明：`权限 / 菜单 / 按钮管理 UI` 已明确转入后续 `Console-ext` 规划，不作为本阶段阻塞项。
...
- 当前状态：未启动，明确不属于 Console 权限治理 V1 范围
- 建议范围：优先补角色授权面板，以及菜单 / 页面 / 按钮授权配置

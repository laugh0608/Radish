...
- **最近结论**：
  ...
  - `P3-12-B1` 账户资产与商城交易 Web 化方案、路由 / 登录回流契约和商城私域正式 Web 入口已完成：新增正式 Web 资产与商城交易 return path，收窄 `/shop/*` 公开路由识别，并接入 `/shop/orders`、`/shop/order/:orderId`、`/shop/inventory`；下一步继续复用既有组件和主题接入资产页、公开购买回流和 `/desktop` 回跳替换，统一 UI 设计后置到页面迁移完成后的 `P3-12-D`，记录见 [P3-12-B1 账户资产与商城交易 Web 化方案](/records/p3-12-b1-account-shop-web-plan-2026-06-21)。
...
1. **启动 P3-12 Web 完全化与 WebOS 收束**
   ...
   - `P3-12-B1` 方案、路由 / 登录回流契约和商城私域正式 Web 入口已完成；下一步复用既有组件和主题接入资产页、公开购买回流，并在替代路径可用后替换直接冲突的 `/desktop` 回跳。
...
- `P3-12 Web 完全化与 WebOS 收束`
  ...
  - `P3-12-B1` 方案、路由 / 登录回流契约和商城私域正式 Web 入口见 [P3-12-B1 账户资产与商城交易 Web 化方案](/records/p3-12-b1-account-shop-web-plan-2026-06-21)；下一步复用既有组件和主题接入余额 / 流水、公开购买动作和交易回流替换。
...
- 第一顺位：复用既有组件和主题接入 `/me/assets`、`/me/assets/transactions`，补余额 / 流水正式 Web 页面。

...
21. `P3-12-D35+`：继续 UI 专题目标扫描与收口，优先评估中宽 PC 固定列交互、移动窄屏表格可读性和已迁移页面真实可用性。
22. `P3-12-E`：P3-12-D UI 专题完成后再进入正式版发布候选，不提前创建发布 tag。

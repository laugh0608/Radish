...
`P3-12-D13` `radish.client` 私域 / 作者态第二批视觉收口检查已完成，结论见 [P3-12-D13 radish.client 私域 / 作者态第二批视觉收口检查记录](/records/p3-12-d13-radish-client-private-author-visual-closure-2026-06-29)。本批移除通知 / 消息 / 圈子 / 宠物状态槽外层重复卡片，统一论坛发帖和 Docs 作者摘要卡 `8px` 半径；D9-D12 涉及的业务契约保持不变。下一步准备 D9-D13 成组阶段验收，真实 Gateway PC / mobile smoke 待用户明确前后端已启动后执行。
...
15. `P3-12-D13`：`radish.client` 私域 / 作者态第二批视觉收口检查已完成，状态槽外层重复卡片和作者摘要卡半径分叉已收敛；下一步准备 D9-D13 成组阶段验收。
16. `P3-12-E`：阶段完成后再进入正式版发布候选，不提前创建发布 tag。

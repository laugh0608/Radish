...
`P3-12-B2` 已完成完整个人中心 Web 化首批代码和正式链接语义补口，结论见 [P3-12-B2 完整个人中心 Web 化方案](/records/p3-12-b2-personal-center-web-plan-2026-06-21)。首批代码已完成 `/me/content`、`/me/history`、`/me/attachments`、`/me/experience` 的正式 Web 路由、登录回流、API helper 收口和页面接入；我的内容与浏览历史列表已补真实公开 `href`，关注关系以既有 `/circle` 为权威入口，`/me` 只提供个人中心联动。当前进入 `P3-12-B3` 论坛作者态 Web 化方案与首批代码范围确认，见 [P3-12-B3 论坛作者态 Web 化方案](/records/p3-12-b3-forum-author-web-plan-2026-06-21)。
...
5. `P3-12-B3`：推进论坛作者态 Web 化，覆盖发帖、编辑、回答、历史查看和作者反馈；方案与首批范围见 [P3-12-B3 论坛作者态 Web 化方案](/records/p3-12-b3-forum-author-web-plan-2026-06-21)。

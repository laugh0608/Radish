...
8. `P3-12-B6`：身份语义二次收口设计已确认，`B6-1` 注册登录与 CurrentUser / OIDC 收敛、`B6-2` 公开展示收敛、`B6-3` 展示名变更治理和 `B6-4` PublicIndex 保留号治理已完成，见 [P3-12-B6 身份语义二次收口设计](/records/p3-12-b6-identity-contract-convergence-design-2026-06-22)。下一步继续 `B6-5` 至 `B6-6`。

...
22. `P3-12-D36+`：继续 UI 专题目标扫描与收口；若剩余问题主要依赖运行态观察，再集中申请 Gateway PC / mobile 真实联调。
23. `P3-12-E`：P3-12-D UI 专题完成后再进入正式版发布候选，不提前创建发布 tag。

...
16. `P3-12-D14`：`radish.console` 视觉代码实现首批已完成，侧栏分组、页面语义组件和系统设置代表页已落地；下一步继续订单 / 用户等高频表格代表页迁移。
17. `P3-12-E`：阶段完成后再进入正式版发布候选，不提前创建发布 tag。

...
> 状态：`P3-12-B1 代码侧主路径已完成；P3-12-C1 首轮 B1 直接残留清理已完成，真实 Gateway PC / mobile 复核后置到小阶段验收；当前进入 P3-12-B2 完整个人中心 Web 化，统一 UI 设计后置到 P3-12-D`
>
...
`P3-12-B2` 当前推进完整个人中心 Web 化，结论见 [P3-12-B2 完整个人中心 Web 化方案](/records/p3-12-b2-personal-center-web-plan-2026-06-21)。首批范围是 `/me/content`、`/me/history`、`/me/attachments`、`/me/experience` 的正式 Web 路由、登录回流、API helper 收口和页面接入；关注关系以既有 `/circle` 为权威入口，`/me` 只提供个人中心联动。
...
4. `P3-12-B2`：推进完整个人中心 Web 化，覆盖我的内容、完整浏览历史、附件管理和经验详情；方案见 [P3-12-B2 完整个人中心 Web 化方案](/records/p3-12-b2-personal-center-web-plan-2026-06-21)。

...
> 状态：`P3-12-B1 代码侧主路径已完成：资产入口、商城私域入口、公开购买回流和公开商城 /desktop 回跳替换均已落地；下一步补 Gateway PC / mobile 复核与 B1 直接残留清理判断，统一 UI 设计后置到 P3-12-D`
>
...
2. `P3-12-B1`：推进账户资产与商城交易 Web 化，方案、路由 / 登录回流契约、商城私域正式 Web 入口、资产正式入口、公开购买回流和公开商城 `/desktop` 回跳替换已完成，见 [P3-12-B1 账户资产与商城交易 Web 化方案](/records/p3-12-b1-account-shop-web-plan-2026-06-21)；下一步补 Gateway PC / mobile 复核。
3. `P3-12-C1`：清理与 B1 直接冲突的 WebOS 残留入口，只处理默认产品路径仍误回 `/desktop` 的链接、文案和路由假设。

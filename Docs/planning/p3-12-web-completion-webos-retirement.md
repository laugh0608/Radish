...
`P3-12-D2` 公开 Web 统一体验设计源首批已完成，结论见 [P3-12-D2 公开 Web 统一体验设计源记录](/records/p3-12-d2-public-web-unified-design-source-2026-06-24)。已创建 `Docs/frontend/design-sources/public-web-unified-experience.pen`，写入 `rx-*` 视觉变量，并补 `P01 - Public Web Shell Foundation` 与 `P02 - Discover Content Stream`。本批仍停留在 Pencil 设计源阶段，不进入 `radish.client` 视觉代码；下一步继续补 `P03` 公开详情阅读、`P04` 公开集合页和 `P05` mobile 单列基线。
...
9. `P3-12-D1 / D2`：统一 UI 设计准备已启动，见 [P3-12-D1 统一 UI 设计准备记录](/records/p3-12-d1-unified-ui-design-prep-2026-06-22)；公开 Web 设计源首批已创建并补 `P01-P02`，见 [P3-12-D2 公开 Web 统一体验设计源记录](/records/p3-12-d2-public-web-unified-design-source-2026-06-24)。后续先补公开详情、公开集合页和 mobile 单列基线，再进入私域 / 作者态设计源与实现准备。

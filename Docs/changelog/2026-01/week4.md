...
- **目录迁移**: 将 `Radish.Core/Lib/radish.lib/` 移动到根目录 `Lib/radish.lib/`
- **配置更新**:
...
- 更新文档站点中所有相关路径引用：
  - `Docs/radish.docs/docs/guide/rust-extensions.md`
  - `Docs/radish.docs/docs/architecture/specifications.md`
  - `Docs/radish.docs/docs/features/rust-extension-implementation.md`
  - `Docs/radish.docs/docs/development-plan.md`
...
**✅ API客户端实现**：
- 创建 `Frontend/radish.client/src/api/paymentPassword.ts` - 支付密码API客户端
- 扩展 `Frontend/radish.client/src/api/coin.ts` - 添加transfer和getStatistics方法
- 完整的TypeScript类型定义
- 统一的错误处理机制

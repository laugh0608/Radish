...
**文件变更统计**：
- 修改：`Docs/radish.docs/docs/guide/radish-coin-system.md` (+348 行)
...
- 修改：`Frontend/radish.client/src/api/attachment.ts` (+15 行)
- 修改：`Frontend/radish.client/src/apps/forum/components/PublishPostForm.tsx` (+50 行)
- 修改：`Frontend/radish.client/src/apps/forum/components/PublishPostForm.module.css` (+50 行)
- 修改：`Frontend/radish.ui/src/components/FileUpload/FileUpload.tsx` (+80 行)
- 修改：`Frontend/radish.ui/src/components/FileUpload/FileUpload.module.css` (+60 行)
- 修改：`.gitignore` (+5 行)
...
- **feat(rust)**: 实现统一的 Rust 扩展库架构
  - **项目结构**：
    - 创建 `Radish.Core/Lib/radish.lib/` 统一 Rust 扩展项目
...
- **refactor(rust)**: 统一 Rust 扩展项目，避免维护多个项目
  - **迁移内容**：
    - 将 test_lib 的性能测试功能迁移到 `Lib/radish.lib/src/benchmark/math.rs`
    - 保留所有性能测试函数：
  ...
  - **目录清理**：
    ...
    - 统一到 `Radish.Core/Lib/radish.lib/` 单一项目
  - **提交**：
...
**文件变更统计**：
- 新增：`Radish.Core/Lib/radish.lib/` 目录（15 个文件，~1500 行）
...
- 新增：`Frontend/radish.client/src/utils/clipboard.ts` (~25 行)
...
- 修改：`Frontend/radish.client/src/apps/profile/components/UserInfoCard.tsx` (+120 行)
- 修改：`Frontend/radish.client/src/apps/profile/components/UserInfoCard.module.css` (+15 行)
- 修改：`Frontend/radish.client/src/apps/profile/components/UserAttachmentList.tsx` (+80 行)
- 修改：`Frontend/radish.client/src/apps/profile/components/UserAttachmentList.module.css` (+50 行)

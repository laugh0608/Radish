...
1. 对第八批至第二十批做批次级验证索引整理，明确各批已执行的 Dart 定向测试、smoke、analyze、Android JVM 单测或文档验证状态；当前索引见 [Flutter Android MVP 第八至第二十批验证索引（2026-05-02）](/records/flutter-android-mvp-validation-index-2026-05-02)

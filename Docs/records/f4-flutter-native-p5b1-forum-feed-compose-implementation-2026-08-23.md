...
> 状态：`P5-B1` 已完成；下一步等待 `P5-B2 Identity / Revisit` 方案确认与独立授权
>
...
下一顺位为 `P5-B2 Identity / Revisit`。该批需要先确认 Profile 独立权威快照、页面 / 测试拆分、公开主页 / 我的三档结构，以及 `User/UpdateMyProfile` 的 dirty / busy / 离开保护；不由 P5-B1 自动授权。

...
- `Radish.DbMigrate` 已补本地结构治理入口，部署态 SQL 已新增 `Deploy/sql/20260620_add_reward_business_keys.sql`。
...
3. 新增版本化 SQL，建议命名为 `Deploy/sql/20260620_add_reward_business_keys.sql`。
...
5. `node Scripts/check-repo-hygiene.mjs Deploy/sql/20260620_add_reward_business_keys.sql Docs/records/wog-4-reward-business-key-uniqueness-plan-2026-06-20.md Radish.Api.Tests/Services/CoinRewardBusinessKeyTest.cs`

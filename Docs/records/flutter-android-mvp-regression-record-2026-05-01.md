...
- [Flutter Android RC 分发前置清单](/records/flutter-android-rc-distribution)
...
- 未执行完整 `flutter test`、Android 平台 JVM 单测、release APK 构建或签名配置检查；准备外部分发前仍需按 [Flutter Android RC 分发前置清单](/records/flutter-android-rc-distribution) 补齐

...
公开商品详情页当前提供复制 canonical 公共链接入口，复制 `https://radishx.com/shop/product/:productId` 这类规范 URL；公开详情不展示订单、背包和购买动作。公开商城到登录后工作台的商品、订单与背包回流契约见 [商城 Web 回流与工作台深链](/guide/shop-web-return-paths)。

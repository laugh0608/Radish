...
- Flutter 的商店构建号独立递增，但展示版本仍跟随产品版本，例如 `26.8.2+1`。
...
- 当前源码产品版本为 `26.8.2`；最近生产部署仍使用固定扩展 tag `v26.7.1.1204-release`。候选版本不代表已经创建 tag 或完成部署。

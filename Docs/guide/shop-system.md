...
> 版本：v1.7 | 最后更新：2026-06-02 | 状态：用户侧购买、订单、背包来源、公开商城到工作台深链、Flutter 登录态单商品购买 / 订单 / 背包承接、购买资格回流和 Console 扣款流水追踪已完成当前阶段目标
...
- ✅ Flutter 移动端已补登录态单商品购买、订单列表、订单详情、背包和来源订单 / 商品查看；移动端不承接购物车、退款、权益激活或道具使用

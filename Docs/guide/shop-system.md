...
>
> 状态：订单履约、消耗品使用、持续权益唯一选择和失效治理已完成；所有持续权益商品仍保持关闭
...
Badge、AvatarFrame、Title、Theme、Signature、NameColor、LikeEffect 当前均禁止销售和启用。Badge / Title 是下一批开放候选，但必须先完成公开主页、帖子和评论中的真实身份装饰消费面。

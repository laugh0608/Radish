...
> 版本：v1.6 | 最后更新：2026-06-01 | 状态：用户侧购买、订单、背包来源、公开商城到工作台深链、Flutter 登录态单商品购买 / 订单 / 背包承接和构建拆包治理已完成当前阶段目标，公开详情分享与 Console 治理转入稳定维护
...
- `Orders` 页面当前已支持真实订单详情、管理员备注、失败订单重试，以及订单到商品 / 用户的治理回跳。

...
> 版本：v1.12 | 最后更新：2026-07-13 | 状态：购买、订单、背包与回流基础已完成；商品真实效力与权益履约进入 F1
...
- [F1. 商品效力与权益履约专题](/features/shop-product-effect-entitlement-fulfillment) - 当前状态真相、商品开放矩阵、实施切片与验收口径

...
> 版本：v1.3 | 最后更新：2026-05-20 | 状态：用户侧购买、订单、背包来源与 WebOS 回访链路已完成当前闭环，公开详情分享与 Console 治理转入稳定维护
...
- ✅ WebOS 私域商城已补齐购买成功进入订单详情、订单通知进入订单详情、订单详情回商品，以及背包权益来源回订单 / 商品的复访链路
...
打开订单详情 → 可回到商品详情
      ↓
用户可在"我的背包"查看/使用权益，并从权益来源回到订单 / 商品
```
...
- 公开商城仍保持只读边界；购买、订单和背包回访只属于登录后的 WebOS 私域商城。

...
> 版本：v1.19 | 最后更新：2026-07-25 | 状态：Console 权限治理、页面类型视觉基座、内容治理案件与申诉、外部 LongId 字符串安全、核心治理域中英文资源、文档审核治理和系统设置治理入口已收口，后续新增或明显改动页面继续按页面类型与稳定契约对齐
...
- 审核台承接人工案件处理、禁言 / 封禁联动、申诉复核、五类目标纠正和治理时间线；批量治理、敏感词、自动策略、多级仲裁仍后置

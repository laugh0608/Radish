...
> 版本：v1.6 | 最后更新：2026-05-11 | 状态：Console-ext 一期持续补边界，当前已扩展到分类、内容治理、胡萝卜、经验等级与商城治理后台
...
- **阶段状态**：已完成角色授权页、资源映射、真实接口收口、`console.access` 入口权限收口，以及分类/标签分管、内容治理、胡萝卜、经验等级与商城治理后台首轮接入，当前进入人工验收与剩余尾项整理阶段

...
> 版本：v1.17 | 最后更新：2026-07-15 | 状态：Console 权限治理、页面类型视觉基座、外部 LongId 字符串安全、核心治理域中英文资源、结构化错误消费、系统设置 / 商品管理版本语义、用户与商城排障回流、文档治理和系统设置治理入口已收口，后续新增或明显改动页面继续按页面类型与稳定契约对齐

...
- ✅ 当前开放 `Site.Branding.FaviconUrl`、账号身份长度、帖子标题 / 正文 / 摘要长度、评论内容长度和论坛轻回应内容 / 返回条数 / 冷却 / 去重窗口设置
...
- ✅ 帖子标题 / 正文 / 摘要长度、评论内容长度和论坛轻回应内容 / 返回条数 / 冷却 / 去重窗口已通过 `ISystemSettingProvider` 接入业务发布 / 编辑 / 列表路径

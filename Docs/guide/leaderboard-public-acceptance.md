...
3. 打开默认经验榜单页 `/leaderboard`，确认首屏会展示“经验体系公开展示”说明区，能说明排行依据、等级含义与只读边界；同时不会误出现“我的经验明细”“经验交易记录”或其他桌面工作台入口。
...
- 默认经验榜单页 `/leaderboard` 会额外给出经验体系公开展示说明；兼容直链 `/leaderboard/experience` 会自动收口回 `/leaderboard`，但不会把“我的经验明细 / 经验交易记录”搬进公开壳层。

...
2. 再按改动主题补专题回归：
   ...
   - React 复用路线、Capacitor Android 技术参考或 Tauri + WebOS 桌面壳相关验证，优先参考 [React 复用路线 Capacitor / Tauri Spike 记录（2026-05-04）](/guide/react-capacitor-tauri-spike-record-2026-05-04)、[Tauri + WebOS 桌面安装包第二轮分发评估清单（2026-05-05）](/guide/tauri-webos-desktop-distribution-evaluation-2026-05-05) 与 [多端客户端路线评估方案](/planning/multiplatform-client-route-evaluation)

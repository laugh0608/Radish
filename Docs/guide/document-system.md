...
1. 在最小纯逻辑回归基线之上，补组件交互与验收清单；
2. 评估正文搜索、分享入口是否需要进入下一阶段；
3. 如后续使用反馈出现目录治理瓶颈，再评估批量重排或拖拽式目录治理；
4. 文档应用当前以稳定维护为主，不再单列新的主线开发任务。
...
1. 在现有回归基线上补齐组件交互与验收清单；
2. 再评估正文搜索、分享入口等下一阶段能力；
3. 若后续使用反馈仍认为目录管理吃力，再回头补拖拽或批量治理。

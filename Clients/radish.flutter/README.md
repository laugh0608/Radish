...
11. 项目所有者当前没有 Apple Developer Program 付费会员或可测试真机，P7-D2 development-signed 真机与 P7-D3 TestFlight Internal Only 暂缓；下一步先审计不依赖 Apple 外部条件的 post-P7 候选，账号删除、完整 Flutter UGC、StoreKit 与商店 metadata 继续后置 D4

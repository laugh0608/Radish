...
10. 下一顺位为 `P7-D1 Internal TestFlight minimal readiness`：只冻结 approved testing Gateway、fail-closed build、privacy / entitlement / export compliance preflight 和 Apple 外部状态授权清单；账号删除、完整 Flutter UGC、StoreKit 与商店 metadata 后置 D4

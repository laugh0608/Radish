...
5. `P5-A / P5-B1 / P5-B2 / P5-C1 / P5-C2` 已完成拆批、Forum Feed / Compose、Identity / Revisit、Docs Reader 与 Commerce Browse / Transaction；下一步进入 P5-C3 Commerce Private readiness，后续再按派生只读面的顺序独立授权；Android UI RC、iOS 与 desktop 平台工程继续等待各自门禁

...
5. `P5-A / P5-B1 / P5-B2 / P5-C1 / P5-C2 / P5-C3 / P5-D1 / P5-D2 / P5-D3` 已完成拆批、Community、Docs、Commerce、资产 / 经验、排行榜与账号浏览历史页面族；P5-E readiness 已完成，下一顺位等待确认后只补 `13` 个代表 widget tests，Android UI RC、iOS 与 desktop 平台工程继续等待各自门禁

...
5. `P5-A / P5-B1 / P5-B2 / P5-C1` 已完成拆批、Forum Feed / Compose、Identity / Revisit 与 Docs Reader；下一步进入 P5-C2 Commerce Browse / Transaction readiness，后续再按 Commerce Private、派生只读面的顺序独立授权；Android UI RC、iOS 与 desktop 平台工程继续等待各自门禁
